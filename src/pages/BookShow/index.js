                                ...
                                <div className={seatClass}
                                    ...
                                    onClick={() => {
                                        ...
                                        if (selectedSeats.includes(seatNumber)) {
                                            ...
                                            setSelectedSeats([...selectedSeats, seat * columns + column + 1]);
                                        }
                                    }}>
    ...
    return (
        show && <div>
            ...
            <div className="flex justify-between card p-2 items-center">
                ...
                <div>
                    <h1 className="text-2xl uppercase">
                        {show.movie?.title}({show.movie?.language})</h1>

                </div>
                <div>
                    <h1 className="text-xl">{moment(show.date).format("MMM Do YYYY")} -{" "}
           ...
           {selectedSeats.length > 0 && ( <div className="mt-2 flex justify-center">
                ...
                billingAddress
                stripeKey='pk_test_51R3XqbP8r71jD3JoGQfCYSU7e4caEI31hMG1wm8wNnPN47VUhkDzuFqFw5xCO0DPgVVQAwiS8bVIFmlIaHNX78jQ00PeK9iSF1'>
