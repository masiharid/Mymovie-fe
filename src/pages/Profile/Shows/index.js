...
import { Col, Modal, Table, Row, message, Form } from 'antd'
...
import { DeleteShow } from '../../../apicalls/theatres';
...
function Shows({ openShowsModal, setOpenShowsModal, theatre }) {
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: "date",
            render: (text, record) => {
                return moment(text).format("MM Do YYYY")
            }
        },
        {
            title: "Time",
    ...
    return (
        ...
        >
            ...
            <hr />
            <div className="flex justify-between mb-1mt-1 items-center">
